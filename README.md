...
Проект персонального ассистента, состоящий из нескольких интегрированных модулей для предоставления персонализированных рекомендаций на основе астрологических расчетов, психологических тестов и машинного обучения.

## 🎯 Общее описание

**Personal Assistant** — это комплексная система, которая анализирует персональные данные пользователя (биоритмы, астрологические аспекты, психометрию) и генерирует персонализированные рекомендации на каждый день. Система состоит из трех основных модулей:

1. **Astra** — модуль машинного обучения и искусственного интеллекта для анализа персональных данных
2. **Testing** — модуль психологического тестирования и анализа потребностей пользователя
3. **Assistant** — модуль генерации персонализированных рекомендаций на основе расчетов Astra и Testing
...
| **Telegram Bot** | Telegram-бот для взаимодействия | - | aiogram, Python |
...
- **ML/AI**: Интеграция с Ollama для генерации рекомендаций
...
│   │   ├── calculators/          # Калькуляторы (биоритмы, матрицы)
│   │   ├── config/               # Конфигурации
...
Telegram бот предоставляет пользователям доступ к функциям системы через мессенджер.

### Настройка бота

1. Создайте бота через [@BotFather](https://t.me/botfather) в Telegram
2. Получите токен бота
3. При запуске workflow введите токен в соответствующее поле

### Основные команды бота

- `/start` — начало работы с ботом
- `/profile` — упра��ление профилем
- `/recommendations` — получение рекомендаций на сегодня
- `/forecast` — прогноз на указанную дату
